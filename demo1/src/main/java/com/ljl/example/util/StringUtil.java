...
public class StringUtil extends StringUtils {
	...
	public static int indexOfDifference(String str1, String str2) {
		if ((equals(str1, str2)) || (str1 == null) || (str2 == null)) {
			return -1;
		}
	...
	/**
	 * parse String like : key1=value1,key2=value2.... to
	...
	public static Map<String, String> parseStringToMap(String str) {
		...
		String keyValueArray[] = split(str, "&");
		Map<String, String> params = new HashMap<String, String>();
		for (String keyValue : keyValueArray) {
			String kvArray[] = split(keyValue, "=");
			if (null != kvArray && 2 == kvArray.length) {
	 ...
	 * @return
	 */
	public static String remindDateFormatter(String remindDate) {
		if (NumberUtils.toInt(remindDate, 0) == 0) {
			return EMPTY_STRING;
		}

		int dateLength = 2;
		if (length(remindDate) == dateLength) {
			return remindDate;
		}

		String remindDateStr = right(remindDate, dateLength);
		return isBlank(remindDateStr) ? EMPTY_STRING : alignRight(remindDateStr, dateLength, '0');
	}

	/**
	 * <p>
	 * 如果字符串为空的话就使用"otherStr" 返回
	 * </p>
	 * 
	 * <pre>
	 * StringUtils.trimToOtherStr(null,"abcd")          = abcd
	 * StringUtils.trimToOtherStr("","abcd")            = abcd
	 * StringUtils.trimToOtherStr("     ","abcd")       = abcd
	 * StringUtils.trimToOtherStr("abc")         = "abc"
	 * StringUtils.trimToOtherStr("    abc    ") = "abc"
	 * </pre>
	 * 
	 * @param str
	 ...
	 */
	public static String trimToOtherStr(String str, String otherStr) {
		String ts = trim(str);
		return isEmpty(ts) ? otherStr : ts;
	}

	/**
	 * <p>
	 * 从右边开始截取指定长度的字符串
	 * <li>StringUtil.subStringRightFixLength("12345",4) = "2345"</li>
	 * <li>StringUtil.subStringRightFixLength("1234",4) = "1234"</li>
	 * <li>StringUtil.subStringRightFixLength("123",4) = "123"</li>
	 * <li>StringUtil.subStringRightFixLength("",4) = ""</li>
	 * </p>
	 * 
	 * @param str
	 * @param length
	 * @return
	 */
	public static String subStringRightFixLength(String str, int length) {
		if (isEmpty(str) || str.length() <= length) {
			return str;
		}

		return substring(str, str.length() - length, str.length());
	}
